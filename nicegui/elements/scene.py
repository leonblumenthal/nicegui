...
class Scene(Element,
            ...
            dependencies=[
                ...
                'lib/three/modules/Line2.js',
                'lib/three/modules/LineMaterial.js',
                'lib/three/modules/LineSegmentsGeometry.js',
                'lib/three/modules/LineGeometry.js',
                'lib/three/modules/LineSegments2.js',
